...
from classes.samm.dataset_c5 import samm_c5_DataSet
...
def run_training(raf_path):
    ...
    for subj in LOSO:
        train_dataset = samm_c5_DataSet(raf_path, phase='train', num_loso=subj, transform=data_transforms,
                                   basic_aug=True, transform_norm=data_transforms_norm)
        val_dataset = samm_c5_DataSet(raf_path, phase='test', num_loso=subj, transform=data_transforms_val)
