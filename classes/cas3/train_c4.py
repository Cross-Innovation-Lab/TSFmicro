...
from classes.cas3.dataset_c4 import cas3_c4_DataSet
...
def run_training(raf_path):
    ...
    for subj in LOSO:
        train_dataset = cas3_c4_DataSet(raf_path, phase='train', num_loso=subj, transform=data_transforms,
                                   basic_aug=True, transform_norm=data_transforms_norm)
        val_dataset = cas3_c4_DataSet(raf_path, phase='test', num_loso=subj, transform=data_transforms_val)
        ...
        net_all = ts_micro(num_classes=4)
