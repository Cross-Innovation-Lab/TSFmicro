...
from fusion.cas2.dataset_cas2_c3 import cas2_c3_RafDataSet
...
sys.stdout = Logger("ts_fusion_cas2_c3.log")
...
def run_training(raf_path):
    ...
    LOSO = ['26', '17', '16', '9', '5', '24', '2', '13', '4', '23', '11', '12', '8', '14', '3', '19', '1', '10',
            '20', '21', '22', '15', '6', '25', '7']
    ...
    for subj in LOSO:
        train_dataset = cas2_c3_RafDataSet(raf_path, phase='train', num_loso=subj, transform=data_transforms,
                                   basic_aug=True, transform_norm=data_transforms_norm)
        val_dataset = cas2_c3_RafDataSet(raf_path, phase='test', num_loso=subj, transform=data_transforms_val)
...
if __name__ == "__main__":
    seed = 112
    raf_path = r'D:\PycharmData\casme2'
    seed_torch(seed)
