...
from fusion.cas2.dataset_cas2_c5 import cas2_c5_DataSet
...
sys.stdout = Logger("ts_fusion_cas2_c5.log")
...
def run_training(raf_path):
    ...
    for subj in LOSO:
        train_dataset = cas2_c5_DataSet(raf_path, phase='train', num_loso=subj, transform=data_transforms,
                                   basic_aug=True, transform_norm=data_transforms_norm)
        val_dataset = cas2_c5_DataSet(raf_path, phase='test', num_loso=subj, transform=data_transforms_val)
    ...
    # #cm = cm.T
    label_name = ['happiness', 'repression', 'disgust', 'surprise', 'Others']
    # 可视化混淆矩阵
    ...
    # plt.savefig('Strategy_0.1.png', dpi=300)
    plt.show()
